#####################################################################
#                                                                   #
# /LiCs_devices/DP832/labscript_devices.py                          #
#                                                                   #
...
class DP832(VISA):
    ...
    def __init__(self, name, VISA_name, 
                range='LOW', volt_limits=(0,5), current_limits=(0,3), limited='volt'):
        '''DP832 DC Power Supply

        The labscript_device for DP832 DC Power supplies. Currently only tested
        for the DP832 3 channel device.
