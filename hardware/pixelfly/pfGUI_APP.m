function varargout = pfGUI_APP(varargin)
...
pos=get(handles.display,'Position');
handles.pos=pos;
%disp(['handles.display position is ',int2str(pos(1)),' ',int2str(pos(2)),' ',int2str(pos(3)),' ',int2str(pos(4))]);
handles.hpanel = imscrollpanel(handles.hfig,handles.image_buffer_map);
% Position the scroll panel to accommodate the other tools.
set(handles.hpanel,'Units','Pixel','Position',[pos(1) pos(2) pos(3) pos(4)]);
...
%  rgb_image = zeros(handles.image_width*3,handles.image_height,'uint8');
  ...
  calllib('PCO_CNV_SDK','CONV_BUF_12TO24',0,handles.image_width,handles.image_height,...
                                  handles.bufaddress,result_image_ptr,handles.bwlutptr);
...
%  rgb_image = zeros(handles.image_width*3,handles.image_height,'uint8');
 ...
 handles.rgb_image=get(result_image_ptr,'Value'); 
 handles.image(1:handles.image_height,1:handles.image_width,3)=handles.rgb_image(1:3:end,:)';      
 handles.image(1:handles.image_height,1:handles.image_width,2)=handles.rgb_image(2:3:end,:)';      
 handles.image(1:handles.image_height,1:handles.image_width,1)=handles.rgb_image(3:3:end,:)';      
 set(handles.image_buffer_map,'CData',handles.image);
end 
...
set(handles.exp_slider,'Enable', 'off');
...
set(handles.exp_slider,'Enable', 'on');
...
handles.maxbw = (maxlut*handles.dgain)/100;
if(handles.maxbw>maxlut)
 handles.maxbw=maxlut;   
end
...
handles.maxbw = (maxlut*handles.dgain)/100;
if(handles.maxbw<handles.minbw)
 handles.maxbw=handles.minbw;   
end
handles.maxred= handles.maxred - (handles.maxred*0.05);   
handles.maxgreen= handles.maxgreen - (handles.maxgreen*0.05);   
handles.maxblue= handles.maxblue - (handles.maxblue*0.05);   
