...
% Last Modified by GUIDE v2.5 13-Aug-2011 17:15:14
...
if handles.mode_index == 1 || handles.mode_index == 2
    if handles.exposure_time > 65.535 
        handles.exposure_time = 65.535;
...
if handles.mode_index == 2 || handles.mode_index == 3 || handles.mode_index == 4
    if handles.num_of_images ~= 1
        handles.num_of_images = 1;
        set(hObject,'String',num2str(handles.num_of_images));
    end
elseif handles.mode_index == 1
