...
class ConnectionTable:
    ...
    def __init__(self):
        ...
        self.Bitter_Precision_Disable__b1c00  = DigitalOut(default_value=5,          name='Bitter_Precision_Disable__b1c00',  parent_device=NIBox1, connection='port0/line0')
        self.Cs_2DMOT_Shutter__b1c01          = DigitalOut(default_value=5,          name='Cs_2DMOT_Shutter__b1c01',          parent_device=NIBox1, connection='port0/line1')
        self.Cs_3DMOT_AO_Sw__b1c02            = DigitalOut(default_value=5,          name='Cs_3DMOT_AO_Sw__b1c02',            parent_device=NIBox1, connection='port0/line2')
        self.Cs_3DMOT_Shutter__b1c03          = DigitalOut(default_value=5,          name='Cs_3DMOT_Shutter__b1c03',          parent_device=NIBox1, connection='port0/line3')
        ...
        self.Cs_HFImg_AO_Sw__b1c05            = DigitalOut(default_value=5,          name='Cs_HFImg_AO_Sw__b1c05',            parent_device=NIBox1, connection='port0/line5')
        ...
        self.Cs_HOP_AO_Sw__b1c08              = DigitalOut(default_value=5,          name='Cs_HOP_AO_Sw__b1c08',              parent_device=NIBox1, connection='port1/line0')
        self.Cs_HOP_Shutter__b1c09            = DigitalOut(default_value=5,          name='Cs_HOP_Shutter__b1c09',            parent_device=NIBox1, connection='port1/line1')
        self.Cs_LFImg_AO_Sw__b1c10            = DigitalOut(default_value=5,          name='Cs_LFImg_AO_Sw__b1c10',            parent_device=NIBox1, connection='port1/line2')
        self.Cs_LFImg_Shutter__b1c11          = DigitalOut(default_value=5,          name='Cs_LFImg_Shutter__b1c11',          parent_device=NIBox1, connection='port1/line3')
        self.Cs_Rep_Shutter__b1c12            = DigitalOut(default_value=5,          name='Cs_Rep_Shutter__b1c12',            parent_device=NIBox1, connection='port1/line4')
        self.Cs_RSC_AO_Sw__b1c13              = DigitalOut(default_value=5,          name='Cs_RSC_AO_Sw__b1c13',              parent_device=NIBox1, connection='port1/line5')
        ...
        self.Cs_VRep_Shutter__b1c16           = DigitalOut(default_value=5,          name='Cs_VRep_Shutter__b1c16',           parent_device=NIBox1, connection='port2/line0')
        self.Cs_Zeeman_Shutter__b1c17         = DigitalOut(default_value=5,          name='Cs_Zeeman_Shutter__b1c17',         parent_device=NIBox1, connection='port2/line1')
        self.DMD_AO_FM__b1c18                 = DigitalOut(default_value=0,          name='DMD_AO_FM__b1c18',                 parent_device=NIBox1, connection='port2/line2')
        self.DMD_AO_Sw__b1c19                 = DigitalOut(default_value=5,          name='DMD_AO_Sw__b1c19',                 parent_device=NIBox1, connection='port2/line3')
        ...
        self.Dual_1064_AO_Sw__b1c22           = DigitalOut(default_value=5,          name='Dual_1064_AO_Sw__b1c22',           parent_device=NIBox1, connection='port2/line6')
        self.Dual_780_AO_Sw__b1c23            = DigitalOut(default_value=5,          name='Dual_780_AO_Sw__b1c23',            parent_device=NIBox1, connection='port2/line7')
        ...
        self.Li_EOM_AO_Sw__b1c26              = DigitalOut(default_value=5,          name='Li_EOM_AO_Sw__b1c26',              parent_device=NIBox1, connection='port3/line2')
        ...
        self.Li_Img_AO_Sw__b1c29              = DigitalOut(default_value=5,          name='Li_Img_AO_Sw__b1c29',              parent_device=NIBox1, connection='port3/line5')
        self.Li_MOT_AO_Sw__b1c30              = DigitalOut(default_value=5,          name='Li_MOT_AO_Sw__b1c30',              parent_device=NIBox1, connection='port3/line6')
        self.Li_MOT_Shutter__b1c31            = DigitalOut(default_value=5,          name='Li_MOT_Shutter__b1c31',            parent_device=NIBox1, connection='port3/line7')
        
        
        self.Li_Rep_AO_Sw__b2c00              = DigitalOut(default_value=5,          name='Li_Rep_AO_Sw__b2c00',              parent_device=NIBox2, connection='port0/line0')
        self.Li_Rep_Shutter__b2c01            = DigitalOut(default_value=5,          name='Li_Rep_Shutter__b2c01',            parent_device=NIBox2, connection='port0/line1')
        ...
        self.Li_Zeeman_Shutter__b2c03         = DigitalOut(default_value=5,          name='Li_Zeeman_Shutter__b2c03',         parent_device=NIBox2, connection='port0/line3')
        ...
        self.Pixelfly_Shutter__b2c06          = DigitalOut(default_value=5,          name='Pixelfly_Shutter__b2c06',          parent_device=NIBox2, connection='port0/line6')
        ...
        self.Cs_LFImg_AO_AM__b3c23            = AnalogOut(default_value=10,          name='Cs_LFImg_AO_AM__b3c23',            parent_device=NIBox3, connection='ao23')
        ...
        self.b4c15                            = AnalogOut(default_value=0,           name='b4c15',                            parent_device=NIBox4, connection='ao15')
...
if __name__ == '__main__':
    ct = ConnectionTable()
    print(ct.Cs_2DMOT_Shutter__b1c01.default_value)
