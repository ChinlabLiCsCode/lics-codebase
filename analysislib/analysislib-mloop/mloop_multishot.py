...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), 'mloop_configs', 'mloop_config_molasses_optimization.toml')
...
if __name__ == '__main__':
    ...
    if (
        ...
        lyse.routine_storage.mloop_config_path = CONFIG_PATH
